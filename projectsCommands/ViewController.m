...
-(void)timerFired{
    if ([self.notifyBox state] == NSOnState) {
        ...
        bool proxy = false;
        NSString *proxyip = @"dev-proxy.oa.com";
        if ([ssid containsString:@"OfficeWiFi"]) {
            proxy = true;
            NSString *proxyip = @"proxy.tencent.com";
        }
        if (![ssid length]) {
            proxy = true;
        }
        NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
        NSString *ip = [defaults objectForKey:@"savedip"]?:proxyip;
...
-(IBAction)updateSelf:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@%@;git st;pod update %@ --no-repo-update;git st;",self.projectName,self.exampleName,self.projectName];
    [self openTerminal:script];
}
-(IBAction)updateQQLGeneratedCode:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@%@;git st;pod update SYNGeneratedCode --no-repo-update;git st;",self.projectName,self.exampleName];
    [self openTerminal:script];
}
-(IBAction)generateSHRun:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@%@;git st; cd lib/SYNGeneratedCode ;sh generate.sh -t;",self.projectName,self.exampleName];
    [self openTerminal:script];
}
...
-(IBAction)commit:(id)sender{
    ...
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@;git st;git add .;git ci -m %@ ;git push origin dev;git st;",self.projectName,content];
    [self openTerminal:script];
}

-(IBAction)status:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@;git st;",self.projectName];
    [self openTerminal:script];
}
...
//        generate = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/QQLiveBroadcast/lib/QQLGeneratedCode;git st;git pull origin dev;"];
//    }
//    if ([self.broadCast state] == NSOnState) {
//        videos = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/QQLiveBroadcast/lib/QQLBroadcast;git st;git pull origin dev;"];
//    }
//    if ([self.social state] == NSOnState) {
//        social = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/QQLiveBroadcast/lib/QQLSocial;git st;git pull origin dev;"];
//    }
//    if ([self.videos state] == NSOnState) {
//        broadcast = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/QQLiveBroadcast/lib/QQLVideos;git st;git pull origin dev;"];
//    }
...
-(IBAction)finderopenDir:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@;open .;",self.projectName];
    [self unixSinglePathCommandWithReturn:script];
}
-(IBAction)submoduleUpdate:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@;git st;git submodule update --init;echo 'submodule already update';git st;",self.projectName];
    [self openTerminal:script];
}
-(IBAction)xcodeopen:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@%@;git st;open -a Xcode %@.xcworkspace;",self.projectName,self.exampleName,self.projectName];
    [self unixSinglePathCommandWithReturn:script];
}
-(IBAction)amend:(id)sender{
    NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@;git st;git add .;git ci --amend --no-edit ;git push origin dev;git st;",self.projectName];
    [self openTerminal:script];
}
...
-(IBAction)reset:(id)sender{
    ...
    [alert beginSheetModalForWindow:self.view.window completionHandler:^(NSModalResponse returnCode) {
        ...
        {
            NSString *script = [NSString stringWithFormat:@"cd /Users/rory/Documents/MyProject/%@;git st;git checkout dev;git reset --hard origin/dev;git pull  origin dev;git st;",self.projectName];
            [self openTerminal:script];
        }
    }];
